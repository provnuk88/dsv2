...
// Используем абсолютный путь для большей надежности
const commandsDir = path.resolve(__dirname, 'commands');
console.log('Путь к директории команд:', commandsDir);

const commands = [];
// Получаем все файлы команд из папок commands/user и commands/admin
...
for (const folder of commandFolders) {
    ...
    console.log('Найдены файлы команд:', commandFiles);
